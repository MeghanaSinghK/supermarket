...
class LoginApp:
    ...
    def setup_ui(self):
        ...
        self.left_frame.place(relx=0, rely=0, relwidth=0.5, relheight=5)
...
class SignupApp:
    def __init__(self, root):
        ...
        self.root.geometry("1000x700")  # Adjusted to match LoginApp for consistency
    ...
    def setup_ui(self):
        ...
        self.login_label = ctk.CTkLabel(self.login_frame, text="Already have an account?", 
                                       font=("Arial", 14), text_color="gray")
        self.login_label.pack(side="left", padx=(0, 0))
