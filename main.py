...
class SuperMarketApp:
    ...
    def load_background_image(self):
        ...
        try:
            ...
            pil_image = pil_image.resize((1000, 600), Image.Resampling.LANCZOS)
    ...
    def create_widgets(self):
        ...
        buttons_frame = ctk.CTkFrame(self.root, fg_color="#bbddf6")
        buttons_frame.place(relx=0.1, rely=0.98, anchor="sw")  # Closer to the bottom-left

        # Common button styles with transparent background
        button_style = {
            "width": 130,
            "height": 45,
            "font": ("Arial", 16, "bold"),
            "corner_radius": 15,  # Rounded buttons
            "fg_color": "#224d81",  # Make the button background transparent
            "hover_color": "b6d8f1",  # Darker hover color for visibility
            "text_color": "#ffffff", # Set text color to white for better visibility
            "border_width": 2,
            "border_color": "black" # Optional: Add a border for better visibility
        }
